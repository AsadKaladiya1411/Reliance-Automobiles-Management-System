...
app.use(morgan(env.nodeEnv === "production" ? ":remote-addr :request-id :method :url :status :res[content-length] - :response-time ms" : ":request-id :method :url :status :response-time ms"));
